    ...
    <section className='bg-background text-white px-5 py-10 md:pl-20' id='apropos'>
        ...
        <div className='flex flex-col justify-between items-center lg:flex-row lg:items-start gap-20 pr-10 mt-24'>
            ...
            <div className='flex flex-col gap-3'>
              ...
              Bonjour, je suis <strong className='text-green font-normal'>Marilyne Tsene</strong>, une camerounaise de 18 ans , actuellement en France etfinissant une formation de  <strong className='text-green font-normal'>développeur FullStack</strong> à <strong className='text-green font-normal'>l&apos;université de la rochelle</strong>. Je suis passionée par la musique , les mangas, le cinéma, stack overflow et l&apos;univers du développement web.<br></br><br></br>
