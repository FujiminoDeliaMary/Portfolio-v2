...
const Contact = () => {
  return (
    <section id="contact" className='flex flex-col justify-center items-center gap-10 bg-background text-white pb-10 pt-24'>
        ...
        <a 
          className='text-4xl text-center text-green hover:drop-shadow-[0_0_15px_rgba(0,255,128,0.8)] transition-all duration-300' 
          href='mailto:marilynedelia@gmail.com'
        >
          Contactez-Moi
        </a>
        ...
        <a 
          className='relative overflow-hidden flex gap-5 border-2 border-green px-4 py-2 text-green group transition-all duration-300' 
          href='mailto:marilynedelia@gmail.com'
        >
          <span className='absolute inset-0 bg-green w-0 group-hover:w-full transition-all duration-500 ease-out'></span>
          <p className={`relative z-10 group-hover:text-background transition-colors duration-300 ${lato.className}`}>Message</p>
          <Image
            src={sendIcon}
